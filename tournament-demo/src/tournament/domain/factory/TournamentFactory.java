...
public class TournamentFactory {
 ...
 public Tournament createTournamentWithPolicy(String name, TournamentType type, RuleSetPolicy ruleSetPolicy){ return switch(type){ case ROUND_ROBIN -> new Tournament(name,type,ruleSetPolicy,new FixedRosterSizePolicy(5),new StandardDisputeWindowPolicy(48),new RoundRobinScheduler()); case ELIMINATION -> new Tournament(name,type,ruleSetPolicy,new FixedRosterSizePolicy(5),new StandardDisputeWindowPolicy(48),new EliminationScheduler()); }; }
}
